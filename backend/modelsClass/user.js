...
var User = /** @class */ (function (_super) {
    ...
    User.prototype.toPublicJSON = function () {
        ...
        var _a = this.toJSON(), password = _a.password, public_user = __rest(_a, ["password"]);
        return public_user;
    };
    User.initModel = function (sequelize) {
        ...
        User.init({
            ...
            tableName: 'Users',
            hooks: {
                beforeSave: function (user) { return __awaiter(_this, void 0, void 0, function () {
