...
var sequelize = new sequelize_1.Sequelize({
    ...
    password: 'pass',
    database: 'TechWeb',
    logging: function (msg) { return console.log("Sequelize: ".concat(msg)); },
    define: {
...
// Initialize models
var user = user_1.User.initModel(sequelize);
var task = task_1.Task.initModel(sequelize);
// Set up associations
user_1.User.associate(task);
task_1.Task.associate(user);
// Sync database
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 4];
                case 4: return [4 /*yield*/, sequelize.sync({
                        force: true
